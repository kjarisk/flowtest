...
var prompt = function prompt(_) {
  return (0, _litHtml.html)(_templateObject3());
};

var choices = function choices(_) {
  return (0, _litHtml.html)(_templateObject4());
};

var index = function index(_) {
  return (0, _litHtml.html)(_templateObject5(), title(), text(), prompt(), choices(), prompt(), choices());
};

window.App = {
  start: function start() {
    (0, _litHtml.render)(index(), document.getElementById('app'));
  }
};
